...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(propertie, propertie.price_difference(reference)) for propertie in properties if (propertie.price_per_sqm * propertie.square_meters)-(reference.price_per_sqm * reference.square_meters)<0]
